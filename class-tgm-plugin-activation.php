	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			$this->strings = array(
				...
				'notice_can_install_required'     => _n_noop(
					...
					'Blur theme requires the following plugin: %1$s.',
					'Blur theme requires the following plugins: %1$s.',
					'tgmpa'
				),
				'notice_can_install_recommended'  => _n_noop(
					/* translators: 1: plugin name(s). */
					'Blur theme recommends the following plugin: %1$s.',
					'Blur theme recommends the following plugins: %1$s.',
					'tgmpa'
				),
		...
		public function filter_plugin_action_links_update( $actions ) {
			$actions['update'] = sprintf(
				...
				esc_attr__( 'Blur plugin needs to be updated to be compatible with your theme.', 'tgmpa' ),
